...
const  ConfirmCallCentreTest = (props: any) => {
        ...
        try{
            ...
            const result = await createTestMutation({ variables: {
                ...
                test: [{
                    ...
                    testType: data.selectedTestType,
                    test:{
                        cluster: data.clientsTest.selectedCluster,
                        DN: data.clientsTest.selectedDN,
                        product: data.clientsTest.selectedProduct,
                        datacenter: data.clientsTest.selectedDataCenter,
                    }
                }]
            }})
            console.log(result)
    ...
    const prevStep = (e: any) => {
        e.preventDefault();
        setStageMutation({ variables: {stage: 'DefineCallCentreTest'} }); 
    };
                        ...
                        <Grid container justify="center" spacing={10}>          
                            <Grid item>
                                ...
                                <ListItem>
                                    <ListItemText
                                        primary="DN"
                                        secondary={data.clientsTest.selectedDN}
                                    />
                                </ListItem>}  
                            </Grid> 
                            <Grid item>
                                ...
                                <ListItem>
                                    <ListItemText
                                        primary="product"
                                        secondary={data.clientsTest.selectedProduct}
                                    />  
                                </ListItem>}    
                            </Grid> 
                            <Grid item>
                                ...
                                <ListItem>
                                    <ListItemText
                                        primary="cluster"
                                        secondary={data.clientsTest.selectedCluster}
                                    />  
                                </ListItem>}    
                            </Grid> 
                            <Grid item>
                                ...
                                <ListItem>
                                    <ListItemText
                                        primary="datacenter"
                                        secondary={data.clientsTest.selectedDataCenter}
                                    />  
                                </ListItem>}    
                            </Grid> 
                        </Grid>
...
export default ConfirmCallCentreTest;